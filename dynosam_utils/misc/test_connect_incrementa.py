...
def main():
    ...
    print(result)
    isam2.saveGraph(f"test_isam2_frame_1.dot")
    ...
    print(result)
    isam2.saveGraph(f"test_isam2_frame_2.dot")
    ...
    print(result)
    isam2.saveGraph(f"test_isam2_frame_3.dot")
    ...
    print(result)
    isam2.saveGraph(f"test_isam2_frame_4.dot")

    isam2.getFactorsUnsafe().saveGraph("test_inc.dot", isam2.calculateBestEstimate())
    ...
    # graph.saveGraph("test_inc.dot", values)
    ...
    # gaussian_elimination_tree.saveGraph("test_bayes_tree_inc.dot")
